...
## Due Date
You must have this exercise completed by the end of next class (10/10). I will be checking the following url to make sure that your page loads properly: `http://people.rit.edu/{youruserid}/igme110`. Double check that it works or you will receive no credit.