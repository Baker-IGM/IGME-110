...
# IGME-110 Introduction to Interactive Media<br>Course Syllabus

### Section {{ site.sectionNumber }}, {{ site.semesterCode }}
...
-   Professor: {{ site.profName }}

    -   Office: {{ site.profOffice }}
    -   Email: {{ site.profEmail }}
    -   Office hours:
        -   {{ site.officeHours }}

-   Class Time/Location:
    -   Tuesdays & Thursdays,  {{ site.sectionStartTime }} -  {{ site.sectionEndTime }},  {{ site.sectionClassroom }}
...
The schedule of topics, readings, and exercises can be found in the [Schedule.md](Schedule) file.It is your responsibility to check the schedule for each week's readings. You will find the in-class exercises very challenging if you do not complete the readings and/or tutorials for that week.
...
-   Last day of add/drop is  {{ site.semesterAddDropDate }}.
-   Last day to withdraw with a grade of “W” is  {{ site.semesterWithdrawDate }}.
